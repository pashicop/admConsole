...
def get_user_list_treedata():
    ...
    for user in users:
        ...
        td.Insert(parent=user_for_td['organization_id'],
                  ...
                  icon=ICON_DISPATCHER5_BASE64 if user_for_td['is_dispatcher'] and not user_for_td['is_blocked'] else
                  ICON_DISPATCHER5_BLOCK_BASE64 if user_for_td['is_dispatcher'] and user_for_td['is_blocked'] else
                  ICON_ADMIN_BASE64 if user_for_td['is_admin'] and not user_for_td['is_blocked'] else
                  ICON_ADMIN_BLOCK_BASE64 if user_for_td['is_admin'] and user_for_td['is_blocked'] else
                  ICON_GW5_BASE64 if user_for_td['is_gw'] and not user_for_td['is_blocked'] else
                  ICON_GW5_BLOCK_BASE64 if user_for_td['is_gw'] and user_for_td['is_blocked'] else
                  ICON_RADIO5_BLOCK_BASE64 if user_for_td['is_blocked']
                  else ICON_RADIO5_BASE64
                  )
