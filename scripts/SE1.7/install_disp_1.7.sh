...
#if [[ $CR -eq 1 ]]
#  then
#    echo -e "deb https://dl.astralinux.ru/astra/stable/1.7_x86-64/repository-main/       1.7_x86-64 main contrib non-free" | sudo tee -a /etc/apt/sources.list
#    echo -e "deb https://dl.astralinux.ru/astra/stable/1.7_x86-64/repository-update/     1.7_x86-64 main contrib non-free" | sudo tee -a /etc/apt/sources.list
#    echo -e "deb https://dl.astralinux.ru/astra/stable/1.7_x86-64/repository-dev/        1.7_x86-64 main contrib non-free" | sudo tee -a /etc/apt/sources.list
#    echo -e "deb https://dl.astralinux.ru/astra/stable/1.7_x86-64/repository-dev-update/ 1.7_x86-64 main contrib non-free" | sudo tee -a /etc/apt/sources.list
