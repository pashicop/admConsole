...
#    echo -e "deb https://dl.astralinux.ru/astra/stable/1.6_x86-64/repository-dev-update/ smolensk main contrib non-free" | sudo tee -a /etc/apt/sources.list
    ...
    echo -e "deb https://dl.astralinux.ru/astra/frozen/1.6_x86-64/1.6.11/repository smolensk main contrib non-free" | sudo tee -a /etc/apt/sources.list
    # Актуальное оперативное обновление основного репозитория
    echo -e "deb https://dl.astralinux.ru/astra/frozen/1.6_x86-64/1.6.11/repository-update/ smolensk main contrib non-free" | sudo tee -a /etc/apt/sources.list
    # Диск со средствами разработки
    echo -e "deb https://dl.astralinux.ru/astra/frozen/1.6_x86-64/1.6.11/repository-dev/ smolensk main contrib non-free" | sudo tee -a /etc/apt/sources.list
    # Актуальное оперативное обновление диска со средствами разработки
    echo -e "deb https://dl.astralinux.ru/astra/frozen/1.6_x86-64/1.6.11/repository-dev-update/ smolensk main contrib non-free" | sudo tee -a /etc/apt/sources.list
