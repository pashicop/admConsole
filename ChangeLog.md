...
2.0.2.0.1.0
* Сохранение ip и логина при нажатии чекбокса Запомнить данные в конфигурационном файле
* Сохранение в кодированном виде логина и пароля для доступа по ssh к серверу (для остановки, запуска сервиса, скачивания лога сервера, установки лицензии и тд), и в открытом виде порта ssh в конфигурационном файле
* Изменение стандартных для нашей системы логина, пароля и порта ssh в настройках
* Сброс настроек доступа по ssh при попытке подключения к другому ip
* 