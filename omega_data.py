...
# ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAF1JREFUOE9jZKAyYKSyeQxDx8D/aF4n2+UgjeiGwcwmy1BkA2EGIFtAsqEwA9E14nI1tkSBopdmBoJsJuRlmKvR1WF1IUGvYFGAbgFYCTZXIYuTnJFIjkVCNoxAAwGnUw8RAmfBHQAAAABJRU5ErkJggg=='
# ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAF1JREFUOE/Vk0EKACAIBPX/jy4MBDGxFfZSx5iG3TIV8lKyT/4RrlS9S+5sydhmlrk7HogSWFjJXToWVmmQAbhqeyq60NJ0lZG0h0EfZSQ0eDI2rfyfnwLf0QukV94x4BERlUU9ZwAAAABJRU5ErkJggg=='
# ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAGFJREFUOE9jZKAyYKSyeQxDy8D/aN7H53qYWgw1MAF0w2BmI2tANgSvgciGYbMAn6VYXYjLNlyuRk8YKIaCODQzEGQzPi8TlWRJiRSSDAQpJiXZ4DR8aOUUosKIkCKqexkA+6AQEWsHX04AAAAASUVORK5CYII='
# ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAHlJREFUOE+1lFEOwCAIQ/H+h57hg2TDFouZ/BnDg9bGYT/XOOQ9ZgZ7T4AOi1r6u8A3DEI7wLxZnD8MFZg3o307IJJI/fOLDFQAUCqaUsHQcJi42BBFoYwHy28GMgt2Xi/BZL6UfqEtr0n2YexRZLlKbFowOQqdH2kCI9cUESM8Q5UAAAAASUVORK5CYII='
# ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAF1JREFUOE9jZKAyYKSyeQxDy8D/aN4ny/UwTeiGwcwm2VCQBmTDsFlAkqHIBqJrxOVq9ISBoo+mBoJsxudlbC7GCA5SIgVmID5foSRsUpINsuEoYUpSDBKTTUeggQCnRhARciEdkAAAAABJRU5ErkJggg=='
ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAFtJREFUOE9jZKAyYKSyeQxDy8D/aN4ny/UwTeiGwcwm2VCQBlyGkWUosoGEXIsrQaD4gqYGEnIBtqDBCGNC3kTWADMQm6/gjsGmgZjIQDYcxWckJwtCWXUEGggAhdsOEetMR+UAAAAASUVORK5CYII='
# ICON_ADMIN_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAFdJREFUOE9jZKAyYKSyeQwj3MD/SOFJdlDANCIbBjOXLEORDUQ2AJsF6AkCq4X4DESXA1kCEoPRWFMcMV5GN4goA0G2EYoUvAZRFPD4chdZMTlqIEoIAAA8qA8RRMds8gAAAABJRU5ErkJggg=='
...
ICON_ADMIN_BLOCK_BASE64 = b'iVBORw0KGgoAAAANSUhEUgAAABQAAAAQCAYAAAAWGF8bAAAAAXNSR0IArs4c6QAAAF9JREFUOE9jZKAyYKSyeQxDy8AQNO+vISc4YF5GNwxmFsmGggzEZRhZhiIbCHMNIQvQQwLFFzQ1EFcc4HM5RhiTEimwoAAZgsxGcQhywiYl2RBlIDnJDkPP0Mp6VPEyAL1oDhGK1XnsAAAAAElFTkSuQmCC'
    ...
    try:
        ...
        sql_to_create = """BEGIN TRANSACTION;
                            ...
                            CREATE TABLE IF NOT EXISTS "Organizations" (
                                ...
                                "LoginPort"	INTEGER NOT NULL UNIQUE,
                                PRIMARY KEY("id")
                            );
                            COMMIT;
                        """
...
def get_org_max_port() -> int:
    orgs = get_orgs_from_db()
    orgs.sort(key=lambda i: i['loginPort'])
    return orgs[-1]['loginPort']
